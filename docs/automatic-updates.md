...
On this macOS/Node 24 workstation, 1,000 warm pinned-bootstrap lookups measured approximately 0.05 ms p50 and 0.07 ms p95. This measures only local dispatch bookkeeping, not total process startup, plugin loading or a universal latency guarantee. The 2.5.2 candidate passed Linux, macOS and Windows checks. Bun plugin execution and native Codex and OpenCode notices were also checked. Claude display verification remains unavailable. See the [release record](release-2.5.2.md) for the scope.
