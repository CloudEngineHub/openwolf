...
On this macOS/Node 24 workstation, 1,000 warm pinned-bootstrap lookups measured approximately 0.05 ms p50 and 0.07 ms p95. This measures only local dispatch bookkeeping, not total process startup, plugin loading or a universal latency guarantee. Native interactive harness rendering and Windows/Bun behavior still require release validation.
